...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://post-builder.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://post-builder.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://post-builder.preview.emergentagent.com',
            'Referer': 'https://post-builder.preview.emergentagent.com/auth',
