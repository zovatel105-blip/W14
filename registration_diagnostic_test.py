...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://circular-crop-tool.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://circular-crop-tool.preview.emergentagent.com',
        'Referer': 'https://circular-crop-tool.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://circular-crop-tool.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://circular-crop-tool.preview.emergentagent.com',
            'Referer': 'https://circular-crop-tool.preview.emergentagent.com/auth',
