...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://visual-consistency-2.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://visual-consistency-2.preview.emergentagent.com',
        'Referer': 'https://visual-consistency-2.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://visual-consistency-2.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://visual-consistency-2.preview.emergentagent.com',
            'Referer': 'https://visual-consistency-2.preview.emergentagent.com/auth',
