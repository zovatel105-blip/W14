...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://survey-results-1.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://survey-results-1.preview.emergentagent.com',
        'Referer': 'https://survey-results-1.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://survey-results-1.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://survey-results-1.preview.emergentagent.com',
            'Referer': 'https://survey-results-1.preview.emergentagent.com/auth',
