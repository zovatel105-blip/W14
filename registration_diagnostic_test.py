...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://socialpoll-1.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://socialpoll-1.preview.emergentagent.com',
        'Referer': 'https://socialpoll-1.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://socialpoll-1.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://socialpoll-1.preview.emergentagent.com',
            'Referer': 'https://socialpoll-1.preview.emergentagent.com/auth',
