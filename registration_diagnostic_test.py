...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://profile-crop-modal.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://profile-crop-modal.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://profile-crop-modal.preview.emergentagent.com',
            'Referer': 'https://profile-crop-modal.preview.emergentagent.com/auth',
