...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://link-share-config.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://link-share-config.preview.emergentagent.com',
        'Referer': 'https://link-share-config.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://link-share-config.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://link-share-config.preview.emergentagent.com',
            'Referer': 'https://link-share-config.preview.emergentagent.com/auth',
