...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://first-story.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://first-story.preview.emergentagent.com',
        'Referer': 'https://first-story.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://first-story.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://first-story.preview.emergentagent.com',
            'Referer': 'https://first-story.preview.emergentagent.com/auth',
