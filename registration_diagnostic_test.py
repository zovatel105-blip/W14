...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://image-crop-fix-1.preview.emergentagent.com',
        'Referer': 'https://image-crop-fix-1.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://image-crop-fix-1.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://image-crop-fix-1.preview.emergentagent.com',
            'Referer': 'https://image-crop-fix-1.preview.emergentagent.com/auth',
