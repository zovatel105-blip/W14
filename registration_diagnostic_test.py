...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://env-account-sync.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://env-account-sync.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://env-account-sync.preview.emergentagent.com',
            'Referer': 'https://env-account-sync.preview.emergentagent.com/auth',
