...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://quick-search-posts.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://quick-search-posts.preview.emergentagent.com',
        'Referer': 'https://quick-search-posts.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://quick-search-posts.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://quick-search-posts.preview.emergentagent.com',
            'Referer': 'https://quick-search-posts.preview.emergentagent.com/auth',
