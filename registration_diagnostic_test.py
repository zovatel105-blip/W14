...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://emoji-to-icon.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://emoji-to-icon.preview.emergentagent.com',
        'Referer': 'https://emoji-to-icon.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://emoji-to-icon.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://emoji-to-icon.preview.emergentagent.com',
            'Referer': 'https://emoji-to-icon.preview.emergentagent.com/auth',
