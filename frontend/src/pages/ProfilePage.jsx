      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <Tabs defaultValue="polls" className="space-y-6">
          ...
          <TabsContent value="followers" className="space-y-6">
            {!followersList.length && !followersLoading ? (
              <div className="text-center py-16">
                <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <UserPlus className="w-12 h-12 text-gray-400" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Sin seguidores aún</h3>
                <p className="text-gray-600 mb-6">Crea contenido increíble para atraer seguidores</p>
              </div>
            ) : (
              <div className="space-y-4">
          ...
          <TabsContent value="following" className="space-y-6">
            {!followingList.length && !followingLoading ? (
              <div className="text-center py-16">
                <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <UserCheck className="w-12 h-12 text-gray-400" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">No sigues a nadie aún</h3>
                <p className="text-gray-600 mb-6">Busca usuarios interesantes para seguir</p>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-6">
                ...
                {followingLoading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {followingList.map((followedUser) => (
                      <Card key={followedUser.id} className="hover:shadow-lg transition-shadow">
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <Avatar className="h-12 w-12">
