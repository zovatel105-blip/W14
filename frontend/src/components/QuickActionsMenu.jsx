  ...
  const actions = [
    {
      ...
      position: { x: -28, y: -8 }, // Arco - izquierda superior
    },
    {
      id: 'create',
      icon: Plus,
      ...
      position: { x: -10, y: -27 }, // Arco - centro superior
    },
    {
      id: 'profile',
      icon: User,
      ...
      position: { x: 10, y: -27 }, // Arco - centro superior derecha
    },
    {
      id: 'favorites',
      icon: Heart,
      ...
      position: { x: 28, y: -8 }, // Arco - derecha superior
    }
  ];
